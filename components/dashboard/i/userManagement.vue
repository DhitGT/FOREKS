<template>
  <div>
    ...
    >
      <div class="bg-gray-700 rounded-lg w-96 p-6">
        <h2 class="text-xl text-gray-100 font-semibold mb-4">Edit User</h2>
        <form @submit.prevent="updateUser">
          <div class="mb-4">
            ...
            <input
              ...
              accept="image/*"
              class="block w-full bg-gray-600 p-2 border text-gray-200 border-gray-800 rounded-lg mt-1"
            />
          ...
          <div class="mb-4">
            ...
            <input
              ...
              class="block bg-gray-600 w-full p-2 border text-gray-200 border-gray-800 rounded-lg mt-1"
              required
            />
          </div>
          <div class="mb-4">
    ...
    <div
      v-if="showModal"
      class="fixed z-40 inset-0 flex items-center justify-center bg-white bg-opacity-50"
    >
      <div class="bg-gray-700 rounded-lg w-96 p-6">
        <h2 class="text-xl text-gray-100 font-semibold mb-4">Add New User</h2>
        ...
        <form @submit.prevent="addUser">
          ...
          <div class="mb-4">
            ...
            <input
              ...
              class="block bg-gray-600 w-full rounded-lg p-2 border text-gray-200 border-gray-800 mt-1"
              required
            />
          </div>
          <div class="mb-4">
            ...
            <input
              ...
              class="block w-full rounded-lg p-2 mt-1 bg-gray-600 text-white"
              required
              color="white"
              bg-color="#FF0000"
              icon
        ...
        <div class="w-2/4 flex gap-4 justify-start items-center">
          <div class="max-w-xl w-2/4">
            ...
            <div class="relative">
              ...
              >
                <i class="mdi mdi-magnify w-5 h-5 text-gray-400"></i>
              </div>
              <input
                type="search"
                v-model="userSearchQuery"
                id="default-search"
                class="block w-full p-4 rounded-lg ps-10 text-sm bg-gray-700 border-gray-800 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                placeholder="Search..."
              />
              <button
                @click="handleSearch"
                class="absolute end-2.5 bottom-2.5 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2 bg-blue-600 hover:bg-blue-700 focus:ring-blue-800"
              >
                Search
              </button>
            </div>
          ...
          >
            ...
            <tbody>
              <tr
                ...
                :key="i"
                class="bg-gray-700 border-b border-gray-800 hover:bg-gray-800"
              >
                <td
                  scope="row"
                  class="px-6 py-4 font-medium text-gray-100 whitespace-nowrap"
                >
                  <div class="flex gap-4 items-center">
                    <v-avatar
                      ><img
                ...
                <!-- <td class="px-6 py-4 text-right">
                  <v-menu offset-y>
                    <template v-slot:activator="{ on, attrs }">
                      <div
                        class="border border-gray-800 rounded-lg px-4 py-2 cursor-pointer bg-gray-700"
                        v-bind="attrs"
                        v-on="on"
                      >
                        Select Access
